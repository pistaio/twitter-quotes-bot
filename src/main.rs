...
fn main() {
    ...
    // twitter_io::revoke_access_token("eFNIMWU1c01vV2R3UVpHaFhUcEZYbFlwVWI0N09uMldJUi1iS2NTamZvcE54OjE2NDc0MDk0ODIyMTQ6MToxOmF0OjE")
    //     .expect("Some error");
...
fn process_chapter_markdowns() {
    ...
    let chapter_file_names: Vec<&str> = vec![
        "chapter_2.md", 
        "chapter_3.md", 
        "chapter_4.md", 
        "chapter_5.md"
